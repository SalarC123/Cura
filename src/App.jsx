...
function App() {
	...
	return (
		<div className="text-white h-screen bg-red-300 flex flex-col items-center justify-center">
			...
			<form className="flex flex-col items-center p-8" onSubmit={e => getDisease(e)}>
				...
				<Select 
					...
					id="symptoms"
				/>
				<input className="py-1 px-2 m-2 rounded-lg text-red-300 font-extrabold bg-white text-xl" type="submit" value="Submit" />
			</form>
		</div>
	);
}
